...
import org.example.inventory_management.table.inventory_management.*
import org.example.inventory_management.table.report.*
import org.example.inventory_management.table.user.*
import org.example.inventory_management.table.user.RoleTable
...
object DatabaseFactory {
    ...
    fun init(environment: ApplicationEnvironment) {
        ...
        transaction(dbMain) {
            ...
            SchemaUtils.createMissingTablesAndColumns(org.example.inventory_management.table.inventory_management.RoleTable)
