...
import com.example.full_stack_ktor.controllers.*
import com.example.full_stack_ktor.exceptions.*
...
import com.example.full_stack_ktor.utils.*
import io.ktor.http.*
        ...
        get("/"){
            call.respondText(
                ...
                text = createHTML().html {
                    ...
                    body {
                        h1 { +"Hello from Ktor!" }
                        p { +"This page is dynamically generated using kotlinx-html DSL." }
                    }
                }
            )
        }
