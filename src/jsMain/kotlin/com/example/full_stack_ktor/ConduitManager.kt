...
import com.example.full_stack_ktor.helper.withProgress
...
object ConduitManager : CoroutineScope by CoroutineScope(Dispatchers.Default + SupervisorJob()) {
    ...
    private val routing = Routing.init(useHash = false, strategy = Strategy.ALL, noMatchWarning = true, root = null)
    val conduitStore = createTypedReduxStore(::conduitReducer, ConduitState())
    ...
    private fun loadArticles() {
        ...
        withProgress {
            ...
            val articleDto = when (state.feedType) {
                ...
                else -> articleService.articles(null, null, null, offset, limit)
            }
